...
- Initial design-first core implementation.
- Gradio UI and Typer CLI.
- Pillow baseline and isolated external provider framework.
- FiDeSR, TinySR and VOSR command contracts.
